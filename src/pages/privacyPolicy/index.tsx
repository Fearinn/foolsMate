...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Fool&apos;s Mate - Privacy Policy</title>
      </Head>
      <main className={styles.policy}>
        <Heading as="h1">Privacy Policy for Fool&apos;s Mate</Heading>

        <p>
          At Fool&apos;s Mate, accessible from https://foolsmate.vercel.app,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by Fool&apos;s Mate and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Fool&apos;s Mate. This policy is not
        ...
        <p>
          Fool&apos;s Mate follows a standard procedure of using log files.
        ...
        <p>
          Fool&apos;s Mate&apos;s Privacy Policy does not apply to other
        ...
        <p>
          Fool&apos;s Mate does not knowingly collect any Personal Identifiable
